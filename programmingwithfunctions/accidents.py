...
# Prompt the user for a filename and open that text file.
    while True:
        ...
        # Prompt the user for a percentage.
                ...
                if perc_reduc < 0:
                    raise ValueError(f'{perc_reduc} is too low. Please enter a new number.')

                elif perc_reduc > 100:
                    raise ValueError(f'{perc_reduc} is too high. Please enter a new number.')
                print()
            ...
            print("That was not a valid filename. Please try again.")
